...
**대상**: 공연 예매 시스템 (Kotlin + Spring Boot 4 + Next.js, 로컬 전용). **가지**: `work/2026-09-14`

| 무엇 | 상태 | 다음 손 |
|---|---|---|
| 진행중 청크 | 없음 | |
| 다음 첫 손 | **`3` 계정·인증 포팅**(ProjectShop `account`·`auth`·`error` → Kotlin). 같이 잡을 수 있는 것: `5`(관측 포팅) | `PLAN.md` 의 `3` 행 |
| PR | 마무리 1차가 `work/2026-09-14` 로 연다(청크 2 하나) | `/wrapup` |
